...
public class GuiCustomFontField extends Gui{
    ...
    public GuiCustomFontField(TTFRenderer par1FontRenderer, int par2, int par3, int par4, int par5)
    {
    ...
    public void drawTextBox()
    {
        if (this.func_146176_q())
        {
            ...
            if (var6)
            {
                if (var13)
                {
                    Gui.drawRect(var11, var8 - 1, var11 + 1, (int) (var8 + 1 + this.field_146211_a.getHeight(text)), -3092272);
                }
                else
                {
            ...
            if (var3 != var2)
            {
                ...
                this.func_146188_c(var11, var8 - 1, var12 - 1, (int) (var8 + 1 + this.field_146211_a.getHeight(text)));
            }
        }
    }
