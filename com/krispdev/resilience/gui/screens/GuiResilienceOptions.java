...
public class GuiResilienceOptions extends GuiScreen{
	...
	public GuiResilienceOptions(GuiScreen screen){
		parentScreen = screen;
	}
	...
	public void initGui(){
		...
		//useGlobalCustomButtons = new CheckBox(8, 8+14*12, Resilience.allowCustomButtons);
	}
	...
	public void drawScreen(int i, int j, float f){
		...
		Resilience.getInstance().getPanelTitleFont().drawCenteredString("Client options:", Resilience.getInstance().getInvoker().getWidth()/2, 8, 0xff0055FF);
	...
	public void mouseClicked(int i, int j, int k){
		...
		//Resilience.allowCustomButtons = useGlobalCustomButtons.isChecked();
